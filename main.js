document.addEventListener('DOMContentLoaded', () => {
    const imageCanvas = document.getElementById('imageCanvas');
        ...
        // Обработчик кликов по изображению
            ...
            loadedImage.onclick = function(e) {
            var imgData = ctx.getImageData((e.offsetX / loadedImage.clientWidth) * loadedImage.width, (e.offsetY / loadedImage.clientHeight) * loadedImage.height, 1, 1)
